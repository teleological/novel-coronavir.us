                    ...
                    {({ geographies }) => (
                        ...
                        // or neighboring states paint over markup
                        {
                            geographies.map(geo => {
                                ...
                                let orders;
                                if (config && config.liftedStart! && this.props.date >= config.liftedStart!) {
                                    orders = "🏁";
                                } else if (config && config.stayStart! && this.props.date >= config.stayStart!) {
                                    orders = "🛑";
...
function buildIndexedStateConfigs(stateConfigs:StateConfig[]) {
    ...
    stateConfigs.forEach(config => {
        ...
        config.liftedStart = config.lifted ?
            parseDate(config.lifted) : undefined;
